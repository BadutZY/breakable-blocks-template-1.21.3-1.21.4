...
public class ObtainableEnd implements ModInitializer {
	...
	private void initializeAnimalSpawnEggs() {
		...
		ANIMAL_SPAWN_EGGS.put(EntityType.COPPER_GOLEM, new ItemStack(Items.COPPER_GOLEM_SPAWN_EGG));
		...
		ANIMAL_SPAWN_EGGS.put(EntityType.NAUTILUS, new ItemStack(Items.NAUTILUS_SPAWN_EGG));
		ANIMAL_SPAWN_EGGS.put(EntityType.ZOMBIE_NAUTILUS, new ItemStack(Items.ZOMBIE_NAUTILUS_SPAWN_EGG));
		ANIMAL_SPAWN_EGGS.put(EntityType.CAMEL_HUSK, new ItemStack(Items.CAMEL_HUSK_SPAWN_EGG));
		ANIMAL_SPAWN_EGGS.put(EntityType.PARCHED, new ItemStack(Items.PARCHED_SPAWN_EGG));
	}
